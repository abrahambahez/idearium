...
## 1. La «Referencia» como objeto epistémico primordial

Desde una perspectiva puramente técnica, una referencia es un registro en una base de datos. Desde una perspectiva sociotécnica, una referencia es un **objeto frontera** [@star_griesemer1989, pp. 393, 404]. Su función es afirmar que algo existe, que puede ser recuperado (verificado, rastreado), que posee cierto tipo de autoridad en una conversación (discusión científica, disputa legal) y que establece una relación social en una red de citación.
