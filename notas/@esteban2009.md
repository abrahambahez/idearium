...
Definición de [arqueoastronomia](arqueoastronomia.md)
...
La falta de un currículum académico integrado internacionalmente para este campo pude ser un factor que dificulte su expansión. Sin embargo, especializaciones como la arqueología del [paisaje](paisaje.md) (*«descripción amplia y multidireccional de los elementos que integran el [paisaje](paisaje.md)»*, p. 74).

En este sentido, es posible que la integración pueda lograrse a través de la colaboración clara entre ambas disciplinas para cada fase de la investigación (por ejemplo, análisis astronómico de las orientaciones arquitectónicas, interpretación arqueológica del [paisaje](paisaje.md) o de los restos de cultura material relevantes para el lugar).
