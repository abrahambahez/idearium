...
## Discusión
La relación entre la [[cognicion-encorporada]] y el aprendizaje puede variar en función de al menos dos factores: el tipo de integración del cuerpo en la tarea (incidental, integrado) y el nivel de involucramiento del cuerpo (bajo, alto). 
