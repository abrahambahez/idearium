...
A partir de las visiones de Malinowski y Radcliffe-Brown, éste propuso la comparación de sociedades para desarrollar un [[analisis-clasificatorio]], utilizando rasgos como los sistemas de parentezco y visiones teóricas como la de las sociedades «cerradas» (desde una visión [[sistema|sistémica]], *sistemas en equilibrio*), pero esta interpretación fue desafiada por perspectivas como las de Edmund Leach y Max Gluckman, que enfatizaban el dinamismo y el conflicto (p. 14).
